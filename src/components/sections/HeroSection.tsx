...
export function HeroSection({ lang }: HeroSectionProps) {
  return (
    <section id="hero" className="min-h-[calc(100vh-4rem)] lg:min-h-screen flex items-center justify-center text-center relative pt-16 lg:pt-0">
      ...
      <div className="container mx-auto px-4 animate-fade-in">
        ...
        <p className="text-md md:text-lg max-w-2xl mx-auto text-muted-foreground mb-10">
        ...
        <Button size="lg" variant="default" className="bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg transform hover:scale-105 transition-transform duration-200" asChild>
          <Link href="#portfolio">
            {heroContent.cta[lang]} <ArrowDown className="ml-2 h-5 w-5 animate-bounce" />
          </Link>
        </Button>
      </div>
    </section>
